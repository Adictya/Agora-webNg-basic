...
console.log('Agora SDK v',AgoraRTC.VERSION)
...
$("#join-aud").click(async function (e) {
...
async function join(aud) {
  client.on("user-published", handleUserPublished);
  client.on("user-joined", handleUserJoined);
  client.on("user-left", handleUserLeft);
  $("#leave").attr("disabled", false);
  $("#join").attr("disabled", true);
  $("#join-aud").attr("disabled", true);
  $("#mic-btn").attr("disabled", aud);
  $("#video-btn").attr("disabled", aud);
